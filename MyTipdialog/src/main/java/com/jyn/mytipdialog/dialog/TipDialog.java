...
package com.jyn.mytipdialog.dialog;
...
public class TipDialog extends Dialog {
    private  static int mDismissTime=0;
    ...
    public void show() {
        super.show();
        if (mDismissTime>0&&mDismissTime<2000){
    ...
    public static class Builder {
         ...
         * @return
         */
        public Builder setDismissTime(int time){
            mDismissTime=time;
            return this;
        }
